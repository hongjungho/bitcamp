...
/* 가상의 컬럼 값을 조회하기*/
select no as num, concat(name,'(',tel,')'), as tilte
from test1;
where working = 'Y';
```
...
insert into test18(title, regdt) values('aaaa', '2017-01-27');
insert into test18(title, regdt) values('bbbb', '2017-2-2');
insert into test18(title, regdt) values('cccc', '2017-2-13');
insert into test18(title, regdt) values('dddd', '2017-3-2');
insert into test18(title, regdt) values('eeee', '2017-4-15');
insert into test18(title, regdt) values('ffff', '2017-6-7');
insert into test18(title, regdt) values('gggg', '2017-6-17');
insert into test18(title, regdt) values('hhhh', '2017-6-27');
insert into test18(title, regdt) values('iiii', '2017-9-5');
insert into test18(title, regdt) values('jjjj', '2017-10-12');
insert into test18(title, regdt) values('kkkk', '2017-11-22');
insert into test18(title, regdt) values('llll', '2017-11-24');
insert into test18(title, regdt) values('mmmm', '2017-12-31');
```

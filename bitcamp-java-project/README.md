...
## src08 - 클래스를 이용한 리팩토링
- 학습목표
  - 클래스 문법을 이용하여 관련 기능을 쉽게 묶는 방법을 배운다.
- 작업내용
  - 팀관련 기능을 별도의 클래스로 분리 한다.
  - 회원관련 기능을 별도의 클래스로 분리 한다.
  - 기능 추가는 없다.

## src07 - 리팩토링
- 학습목표
  - 반복되는 코드를 메서드로 분리하는 연습을한다.
- 작업내용
...
## src05 - 메서드 적용
- 학습목표
  - 메서드를 사용하여 코드를 기능 단위로 분리 하는 방법을 배운다.
- 작업내용
  - 추가하는 기능 없다.
